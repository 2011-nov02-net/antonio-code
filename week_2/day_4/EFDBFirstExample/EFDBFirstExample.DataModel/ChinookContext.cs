...
namespace EFDBFirstExample.DataModel
{
    public partial class ChinookContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("Department", "practice");
            ...
            {
                entity.ToTable("EmpDetails", "practice");
                ...
                entity.Property(e => e.Salary).HasDefaultValueSql("((40000))");
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasConstraintName("FK__EmpDetail__Emplo__29221CFB");
            });
            ...
            {
                entity.ToTable("Employee", "practice");
                ...
                entity.HasOne(d => d.Dept)
                    ...
                    .HasConstraintName("FK__Employee__DeptID__2645B050");
            });
